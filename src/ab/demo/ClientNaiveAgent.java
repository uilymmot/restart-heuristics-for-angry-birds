...
//		System.out.println("Hello");
		...
		try {
			...
			System.out.println("FAILED TO CREATE OUTPUTS FILE");
		}
		...
		while (true) {
			...
			// DO THE THING WHERE WE CHECK LEVEL SOLVABILITY HERE
...

	{
		...
		objs.addAll(vision.findBirdsMBR());
		objs.addAll(vision.findPigsMBR());
		objs.addAll(vision.findTNTs());
		objs.addAll(vision.findBlocksMBR());
...
//					writer.write(sa.SupportGraph[i][j]);
////					System.out.print(sa.SupportGraph[i][j]);
//				}
//				writer.newLine();
////				System.out.println("");
//			}
...
//		HashMap<Integer, ArrayList<Map.Entry<Integer, Integer>>> SupportStructure = sa
//					.getSupportStructure();
